export declare const AGENTCANVAS_EXPERIENCE_V1: "agentcanvas-experience-v1";
export declare const AGENTCANVAS_EXPERIENCE_V2: "agentcanvas-experience-v2";
export declare const agentCanvasTemplates: readonly ["chat", "coding", "research", "artifact", "tool-heavy", "multi-provider"];
export type AgentCanvasTemplate = (typeof agentCanvasTemplates)[number];
export declare const agentCanvasRegions: readonly ["sidebar", "main", "composer", "right-panel", "bottom-dock", "overlay"];
export type AgentCanvasRegion = (typeof agentCanvasRegions)[number];
export declare const agentCanvasSlotComponents: readonly ["SessionSidebar", "ChatFrame", "ComposerFrame", "OutputFrame", "GitFrame", "ExportFrame", "DebugDock", "CapabilityTray"];
export type AgentCanvasSlotComponent = (typeof agentCanvasSlotComponents)[number];
export declare const themePresetIds: readonly ["console-light", "graphite", "oxide", "studio-neutral", "paper-trail", "terminal-green"];
...
export type AgentCanvasExperienceV1 = {
    ...
    theme?: {
        ...
        radius?: number;
        motion?: {
            reasoning?: "minimal" | "pulse" | "wave" | "terminal" | "shimmer" | "bars" | "orbit";
    ...
    output?: {
        ...
        artifactRenderer?: "auto" | "code" | "diff" | "markdown" | "preview" | "data";
        surface?: "right-panel" | "overlay";
        supportedArtifactRenderers?: Array<"code" | "diff" | "markdown" | "preview" | "data">;
    };
    export?: {
        target?: "vite-react";
...
export type CompleteAgentCanvasExperienceV1 = {
    ...
    theme: Omit<Required<NonNullable<AgentCanvasExperienceV1["theme"]>>, "motion"> & {
        motion: Omit<Required<NonNullable<NonNullable<AgentCanvasExperienceV1["theme"]>["motion"]>>, "writingParams"> & {
            writingParams: Required<NonNullable<NonNullable<NonNullable<AgentCanvasExperienceV1["theme"]>["motion"]>["writingParams"]>>;
        };
    };
    composer: Required<NonNullable<AgentCanvasExperienceV1["composer"]>>;
    conversation: Omit<Required<NonNullable<AgentCanvasExperienceV1["conversation"]>>, "messageActions"> & {
        messageActions: Required<NonNullable<NonNullable<AgentCanvasExperienceV1["conversation"]>["messageActions"]>>;
    };
...
export declare const agentCanvasSurfaceModes: readonly ["agentcanvas", "custom"];
export type AgentCanvasSurfaceMode = (typeof agentCanvasSurfaceModes)[number];
export declare const agentCanvasBuiltinMarks: readonly ["sparkles", "messages-square", "bot", "terminal", "search", "chart"];
export type AgentCanvasBuiltinMark = (typeof agentCanvasBuiltinMarks)[number];
export declare const agentCanvasStylesheetLayers: readonly ["base", "theme", "overrides"];
export type AgentCanvasStylesheetLayer = (typeof agentCanvasStylesheetLayers)[number];
export declare const agentCanvasColorModes: readonly ["theme", "light", "dark", "system"];
export type AgentCanvasColorMode = (typeof agentCanvasColorModes)[number];
export type AgentCanvasBrandMarkV2 = {
    kind: "builtin";
    id: AgentCanvasBuiltinMark;
} | {
    kind: "asset";
    assetId: string;
};
...
export type CompleteAgentCanvasExperienceV2 = Omit<AgentCanvasExperienceV2, "canvas" | "design" | "extensions"> & {
...
export type AgentCanvasExperience = AgentCanvasExperienceV1 | AgentCanvasExperienceV2;
