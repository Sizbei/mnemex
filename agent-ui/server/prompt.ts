...
export function systemPrompt(sessionId: string): string {
  return [
    ...
    "",
    "Call analyze only for analytical questions recall and timeline cannot express, such as",
    "counts, rankings or comparisons across topics. It takes read-only Cypher and its",
    "description carries the graph schema. Do not use it for questions recall already answers.",
    "",
